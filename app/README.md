...
- filename comparators are supported as exact-match checks too (e.g. `#name=clip.mp4`, `#name!=clip.mp4`), including aliases `#file...` and `#filename...`
...
- malformed `#name...` / `#file...` / `#filename...` comparator tags show clickable name examples (`#name=clip.mp4`, `#name!=clip.mp4`) and preserve include/exclude prefix + alias choice
