...
- Comparator fragments like `#src=` / `#out=` / `#dur=` also keep root-level suggestions visible for quick recovery (including range presets like `#src=2k..4k`, `#dur=1..2`, `#dur=..2`).
