...
- Malformed `#name...` / `#file...` / `#filename...` comparator tags now surface clickable filename examples (`#name=clip.mp4`, `#name!=clip.mp4`, `#name*=clip`) with include/exclude prefix + alias preservation.
